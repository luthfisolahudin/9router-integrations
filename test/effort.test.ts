...
test("maps every measured model to its highest observed route effort", () => {
	...
	assert.equal(measuredWireEffort("cbcn/deepseek-v4-flash"), "xhigh");
	assert.equal(measuredWireEffort("cbcn/deepseek-v4.1-flash"), "xhigh");
	assert.equal(measuredWireEffort("cbcn/glm-5.3"), "max");
	assert.equal(measuredWireEffort("cbcn/kimi-k3"), "max");
	assert.equal(measuredWireEffort("cbcn/kimi-k3-1"), "xhigh");
	assert.equal(measuredWireEffort("cx/gpt-6-astra"), "max");
	assert.equal(measuredWireEffort("cx/gpt-5.6-sol"), "max");
	...
	assert.equal(measuredWireEffort("ag/gpt-oss-120b-medium"), "xhigh");
});
